...
public class JuegoSnake extends JFrame {
	...
	Rectangle rect = new Rectangle(20, 20, 15 * 50, 15 * 35);
	Snake snake;
	SNode node;
	public JuegoSnake() {
...
class Snake {   
	...
	JuegoSnake interFace;
	int dir=JuegoSnake.R;
	public Snake(JuegoSnake interFace) {
		this.interFace = interFace;
		nodes.add(new SNode(20 + 150, 40 + 150, Color.GREEN));
		addNode();
	}
